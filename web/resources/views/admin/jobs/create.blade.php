...
@section('content')
    <div class="page-header">
        ...
        <p>Create a new job listing for your site.</p>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="salary_range" name="salary_range" class="form-control @error('salary_range') is-invalid @enderror" value="{{ old('salary_range') }}" placeholder="e.g. ৳30,000 - ৳50,000">
                            @error('salary_range')<div class="form-error">{{ $message }}</div>@enderror
                        </div>
                        <div class="form-group">
                            <label for="application_deadline">Application Deadline</label>
                            <input type="date" id="application_deadline" name="application_deadline" class="form-control @error('application_deadline') is-invalid @enderror" value="{{ old('application_deadline') }}">
                ...
                <div class="form-section">
                    ...
                    <div class="upload-area" onclick="document.getElementById('imageInput').click()">
                        ...
                        <p>Click to upload company or job image</p>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="6" placeholder="Describe the role, responsibilities, benefits...">{{ old('description') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <textarea id="requirements" name="requirements" class="form-control @error('requirements') is-invalid @enderror" rows="5" placeholder="One requirement per line&#10;e.g.&#10;Bachelor's degree in relevant field&#10;2+ years experience&#10;Strong communication skills">{{ old('requirements') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-check">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : 'checked' }}>
