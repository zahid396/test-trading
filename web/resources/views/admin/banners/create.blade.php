            ...
            <div class="card-body">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Optional - shown over the banner">
                        @error('title')<div class="form-error">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label for="subtitle">Subtitle</label>
                        <input type="text" id="subtitle" name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle') }}" placeholder="Optional - shown under the title">
                        @error('subtitle')<div class="form-error">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label for="button_text">Button Text</label>
                        <input type="text" id="button_text" name="button_text" class="form-control @error('button_text') is-invalid @enderror" value="{{ old('button_text') }}" placeholder="Optional - e.g. Buy Now">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display:flex; flex-wrap:wrap; gap:1.5rem; margin-top:0.375rem;">
                            <label class="form-check">
                                <input type="radio" name="media_type" value="image" {{ old('media_type', 'image') == 'image' ? 'checked' : '' }} onchange="toggleMediaField()">
                                <span>Uploaded Image</span>
                            </label>
                            <label class="form-check">
                                <input type="radio" name="media_type" value="youtube" {{ old('media_type') == 'youtube' ? 'checked' : '' }} onchange="toggleMediaField()">
                    ...
                    <div id="videoMediaBlock" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="url" id="video_url" name="video_url" class="form-control @error('video_url') is-invalid @enderror" value="{{ old('video_url') }}" placeholder="https://www.youtube.com/watch?v=VIDEO_ID">
